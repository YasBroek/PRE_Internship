...
instancia = "MAPF_code/input/room-32-32-4/instance/"
...
test_instance = MAPF_code.convert_to_my_struct(
    file_instance,
    readlines("MAPF_code/input/room-32-32-4/instance/room-32-32-4-random-1.scen"),
    12,
)

model, losses = MAPF_code.training_weights(
    instance_list, best_solutions_list, 0.001, 10, 0.1, 300, test_instance
)
